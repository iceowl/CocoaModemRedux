...
#import "riglist.h"	/* list in another file to not mess up w/ this one */
 ...
 */
struct confparams {
  rigToken_t token;		/*!< Conf param token ID */
...
struct rig_caps {
  ...
  int (*set_ext_level)(RIG *rig, vfo_t vfo, rigToken_t token, value_t val);
  int (*get_ext_level)(RIG *rig, vfo_t vfo, rigToken_t token, value_t *val);

  int (*set_ext_parm)(RIG *rig, rigToken_t token, value_t val);
  int (*get_ext_parm)(RIG *rig, rigToken_t token, value_t *val);

  int (*set_conf) (RIG * rig, rigToken_t token, const char *val);
  int (*get_conf) (RIG * rig, rigToken_t token, char *val);
...
extern HAMLIB_EXPORT(int) rig_set_conf HAMLIB_PARAMS((RIG *rig, rigToken_t token, const char *val));
extern HAMLIB_EXPORT(int) rig_get_conf HAMLIB_PARAMS((RIG *rig, rigToken_t token, char *val));
...
extern HAMLIB_EXPORT(int) rig_set_ext_level HAMLIB_PARAMS((RIG *rig, vfo_t vfo,
			rigToken_t token, value_t val));
extern HAMLIB_EXPORT(int) rig_get_ext_level HAMLIB_PARAMS((RIG *rig, vfo_t vfo,
			rigToken_t token, value_t *val));

extern HAMLIB_EXPORT(int) rig_set_ext_parm HAMLIB_PARAMS((RIG *rig, rigToken_t token, value_t val));
extern HAMLIB_EXPORT(int) rig_get_ext_parm HAMLIB_PARAMS((RIG *rig, rigToken_t token, value_t *val));
...
extern HAMLIB_EXPORT(const struct confparams *)  rig_ext_lookup_tok HAMLIB_PARAMS((RIG *rig, rigToken_t token));
extern HAMLIB_EXPORT(rigToken_t) rig_ext_token_lookup HAMLIB_PARAMS((RIG *rig, const char *name));
...
extern HAMLIB_EXPORT(rigToken_t) rig_token_lookup HAMLIB_PARAMS((RIG *rig, const char *name));
