...
- (void)missingPTT:(int)index name:(NSString*)name
{
	...
	[ Messages alertWithMessageText:NSLocalizedString( @"missing ptt", nil ) informativeText:[ NSString stringWithFormat:@"PTT device %s is not found.", [ name cStringUsingEncoding:NSASCIIStringEncoding  ] ] ] ;
}
