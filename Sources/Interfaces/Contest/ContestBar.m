...
- (id)initIntoTabView:(NSTabView*)tabview app:(Application*)app
{
	...
	if ( self ) {
		...
		if ( [ [NSBundle mainBundle] loadNibNamed:@"ContestBar" owner:self topLevelObjects:nil] ) {
...
- (void)retrieveForPlist:(Preferences*)pref
{
	...
	[ pref setInt:(int)[ macroMenu indexOfSelectedItem ] forKey:kContestRepeatMenu ] ;
}
...
- (IBAction)repeatMacro:(id)sender 
{
	...
	tag = (int)[ [ macroMenu selectedItem ] tag ] ;
	if ( tag == 1111 ) {
		//  "last macro"
		if ( index < 0 || sheet < 0 ) {
