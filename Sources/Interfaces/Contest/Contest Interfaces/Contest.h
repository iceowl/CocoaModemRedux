...
//
	...
	@interface Contest : StripPhi <NSXMLParserDelegate> {
...
@property (retain) NSString *contestName ;
@property (retain) NSString *prototypeName ;
@property (retain) NSString *savedCallsign ;
@property (retain) NSString *savedExchange ;
@property (retain) NSString *usedCallString;
@property (retain) NSMutableString *previousCall;
