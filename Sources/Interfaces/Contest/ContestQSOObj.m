...
- (NSString*)callsign
{
	return [ NSString stringWithCString:qso->callsign->callsign encoding:NSASCIIStringEncoding] ;
}
...
- (void)setRST:(NSString*)rst 
{
	...
	p = 599 ;
	sscanf( [ rst cStringUsingEncoding:NSASCIIStringEncoding  ], "%d", &p ) ;
	qso->rst = p ;
}
...
- (void)setExchange:(NSString*)exch 
{
	...
	strcpy( qso->exchange, [ exch cStringUsingEncoding:NSASCIIStringEncoding  ] ) ;
}
