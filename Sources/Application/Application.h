...
@property  AuralMonitor        *auralMonitor;
@property  Config              *config;
@property  UserInfo            *userInfo;
@property  DigitalInterfaces   *digitalInterfaces;
@property  FSKHub              *fskHub;
@property  MacroScripts        *macroScripts;
@property  AudioManager        *audioManager;
@property (retain) NSTextView  *selectedTextView;
