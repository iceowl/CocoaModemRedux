...
@property (retain)  NSConditionLock *timerThreadLock;
@property (retain)  NSThread        *timerThread;
@property (retain)  NSLock          *tickLock;
@property (retain)  NSTimer         *runTimer;
//@property           NSString *serviceName;
@property           NetAudioStruct  *netAudioStruct;
