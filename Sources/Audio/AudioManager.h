...
#define MAXREGISTEREDDEVICES 256
#define MAXCASHEDDEVICES 2048
...
@property (retain) NSMutableArray *registeredAudioDevice;
@property (retain) NSMutableArray *cachedDevice;
