...
@interface PSKBrowserTable : NSObject {
	...
	IBOutlet NSTextField* alarmTextField ;
...
@property (retain) NSTableColumn *freqColumn ;
@property (retain) NSTableColumn *textColumn ;
@property (retain) NSDictionary *alarmText ;
@property (retain) NSLock *busy ;
@property (retain) NSString *dot, *null ;
@property (retain) NSMutableString *returnString ;
@property (retain) NSMutableAttributedString *attributedString ;
//  vfo offsets
@property (retain) NSTimer *refreshCheck ;
//  alarms
@property (retain) NSString *alarmString ;
@property (retain) NSLock *alarmLock ;
