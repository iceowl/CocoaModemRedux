...
- (void)setBrowserTable:(NSTableView*)view
{
	...
	if ( view ) {
		...
		[ table setDataSource:(id <NSTableViewDataSource>)browserTable ] ;
		[ table setDelegate:(id <NSTableViewDelegate>)browserTable ] ;
	}
}
