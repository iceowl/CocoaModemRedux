...
- (id)initIntoView:(NSView*)view client:(Modem*)modem index:(int)inIndex
{
	...
	if ( self ) {
		...
		index = inIndex ;
		pskMode = kBPSK31 ;
		if ( [ [NSBundle mainBundle] loadNibNamed:@"PSKControl" owner:self topLevelObjects:nil] ) {
...
- (int)pskMode
{
	...
	//  v0.88  sanity check
	n = (int)[ modeMenu indexOfSelectedItem ] ;
	if ( n < 0 ) {
		n = 0 ;
...
- (void)modeMenuChanged
{
	...
	[ self changeModeToIndex:(int)[ modeMenu indexOfSelectedItem ] ] ;
}
