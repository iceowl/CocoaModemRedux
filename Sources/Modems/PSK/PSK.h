...
//
    ...
    #ifndef _PSK_H_
	#define _PSK_H_
    #define MAXAURALACTION 4
	#import <Cocoa/Cocoa.h>
	#import "ContestInterface.h"
	#import "AYTextView.h"
	#import "CMPSKModes.h"
    #import "AuralAction.h"
...
//	} AuralAction ;
	...
	@interface PSK : ContestInterface {
		...
		//SubDictionary *auralMonitorPlist[MAXAURALACTION] ;		//  0,1 = receiver, 2 = transmitter, 3 = wideband
		//AuralAction *auralAction[MAXAURALACTION] ;
...
@property (retain) NSMutableArray *auralAction;
@property (retain) NSMutableArray *subDictionary;
@property (retain) NSMutableArray *auralMonitorPlist;
