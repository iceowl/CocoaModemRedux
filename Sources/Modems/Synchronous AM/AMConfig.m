...
@synthesize outbufLock = _outbufLock;
...
- (Boolean)updateFromPlist:(Preferences*)pref
{
	...
	[(NSButton*) activeButton setState:( [ pref intValueForKey:kSynchAMActive ] == 1 ) ? NSOnState : NSOffState ] ;
...
- (void)retrieveForPlist:(Preferences*)pref
{
	...
	[ pref setInt:( [ (NSButton*)activeButton state ] == NSOnState )? 1 : 0 forKey:kSynchAMActive ] ;
}
