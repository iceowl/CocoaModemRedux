...
@property RTTYRxControl *rttyRxControl;
@property RTTYConfigSet *configSet;
@property RTTYModulator *afsk;
@property FSK           *fsk;
@property CMFIR         *transmitBPF;
@property int           currentLow,currentHigh;
