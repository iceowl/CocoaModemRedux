...
typedef void (^GraphEllipseBlock)(void);
	...
	//	NSLock *lock ;
        ...
        dispatch_queue_t ellipseQueue;
        GraphEllipseBlock gBlock;
        NSRect currentRect;
	}

    @property (retain)  NSImage  *image;
    @property (retain)  NSBitmapImageRep *bitmap;
    @property (retain)  NSColor *scaleColor;
    @property (retain)  NSBezierPath *axis;
    @property (retain)  NSLock *lock,*overrun;
