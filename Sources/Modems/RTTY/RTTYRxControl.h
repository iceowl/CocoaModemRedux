...
@property RTTYWaterfall *waterfall;
@property RTTYReceiver  *receiver;
@property ModemConfig   *config;
@property RTTY          *client;
@property Spectrum      *spectrumView;
@property RTTYMonitor   *monitor;
@property SubDictionary *auralMonitorPlist;
