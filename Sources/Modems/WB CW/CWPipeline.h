...
@property float* noiseBuffer;
@property float* dataBuffer;
@property float* iFiltered;
@property float* qFiltered;
@property float* iDecimateFiltered;
@property float* qDecimateFiltered;
