...
@property (retain)  NSLock       *getCallLock;
@property (retain)  NSLock       *waterfallLock;
@property (retain)  NSLock       *transmitCountLock;
@property (retain)  NSDate       *waterfallDate;
@property (retain)  NSTimer      *timeout;
@property (retain)  NSString     *ident;
@property (retain)  NSTabViewItem *modemTabItem ;
@property (retain)  NSTabView    *controllingTabView ;
@property (retain)  NSColor      *textColor;
@property (retain)  NSColor      *backgroundColor;
@property (retain)  NSColor      *sentTextColor;
@property (retain)  NSColor      *plotColor ;
@property           ModemManager *manager;
