...
- (id)initWithFrame:(NSRect)frame
 {
    ...
    if ( self ) {
		...
		_background = [ NSColor colorWithCalibratedRed:0.0 green:0.0 blue:0.0 alpha:0 ];
		_foreground = [ NSColor colorWithCalibratedRed:1.0 green:1.0 blue:1.0 alpha:0 ] ;
		_txColor = [ NSColor colorWithCalibratedRed:0.0 green:1.0 blue:1.0 alpha:0 ] ;
		...
		[ self setGrayscale:_background to:_foreground index:0 ] ;
		[ self setGrayscale:_background to:_txColor index:1 ] ;
