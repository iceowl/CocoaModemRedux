...
- (id)initWithFrame:(NSRect)frame 
{
	int i ;
	NSSize size ;
	CGFloat x, y, h, s, dash[2] = { 1.0, 2.0 }, closedash[2] = { 1.0, 1.0 } ;
	...
	//	[ ( backgroundColor = [ NSColor colorWithDeviceRed:0 green:0.1 blue:0 alpha:1 ] ) retain ] ;
        ...
        spectrumColor = [ NSColor colorWithCalibratedRed:0.9 green:0.9 blue:0 alpha:1 ]  ;
...
//[ ( waveformColor = [ NSColor colorWithCalibratedRed:0 green:1 blue:0.1 alpha:1 ] ) retain ] ;
        ...
        markSpaceColor = [ NSColor colorWithCalibratedRed:1 green:0 blue:0 alpha:1 ] ;
...
- (void)averageMenuChanged
{
	...
	if ( averagePopupMenu ) {
		t = (int)[ averagePopupMenu indexOfSelectedItem ] ;
