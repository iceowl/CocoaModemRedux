...
- (id)initWithFrame:(NSRect)frame 
{
    ...
    if ( self ) {
		...
		plotColor = [NSColor colorWithCalibratedRed:0.9 green:0.9 blue:0 alpha:1 ];
		plot = nil ;
		...
		//  scale
		scaleColor = [ NSColor colorWithCalibratedRed:0 green:1 blue:0.1 alpha:1 ];
