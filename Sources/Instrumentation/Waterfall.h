...
@property (retain) NSColor *red, *magenta, *green, *black ;
@property (retain) NSLock           *drawLock;
@property (retain) NSThread         *thread;
@property (retain) NSImage          *image;
@property (retain) NSBitmapImageRep *bitmap;
@property (retain) dispatch_queue_t timerQueue;
@property          CMFFT            *spectrum;
