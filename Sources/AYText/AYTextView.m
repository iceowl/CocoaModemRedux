...
- (TextAttribute*)newAttribute
{
	...
	//[ a->font retain ] ;
	//  default text color
	a.textColor = [ NSColor colorWithCalibratedRed:1 green:0.8 blue:0 alpha:1 ] ;
...
- (void)append:(char*)s
{
	...
	string = [ NSString stringWithCString:s encoding:NSASCIIStringEncoding ] ;
...
- (void)scrollToEnd
{
	...
	if ( [ self lockFocusIfCanDraw ] ) {
		length = (int)[ [ self textStorage ] length ] ;
